import { A as AstroError, N as NoImageMetadata, i as UnsupportedImageFormat, h as MissingSharp } from './entrypoint_QWSr6fnu.mjs';
import { b as baseService, d as detector, r as resolveDefaultOutputFormat, p as parseQuality } from './generic_D8J0vo9C.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_BpBIH5sJ.mjs').then(n => n.i)).default;
  } catch {
